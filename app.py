...
def result():
    ...
    scaler_path=os.path.join('/home/adarsh/Downloads/Machine learning/Project/models','scaler.pkl')
    scaler=None
    ...
    stack_model_path=os.path.join('/home/adarsh/Downloads/Machine learning/Project/models','model.bin')
